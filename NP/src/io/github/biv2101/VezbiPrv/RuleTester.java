    ...
    public static void main(String[] args) {
        ...
        if (testCase == 1) { //Test for String,Integer
            ...
            * */
            ...
            rules.add(new Rule<>(student -> student.grades.size() >= 3, f -> f.grades.stream().mapToDouble(g -> g).max().orElse(0)));
            ...
            rules.add(new Rule<>(student -> student.id.startsWith("20"), f -> f.grades.stream().mapToDouble(g -> g).average().orElse(5.0)));

...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        SLLNode<Card> mostsig = firstSorcererCards.getFirst();
        for (SLLNode<Card> curr = firstSorcererCards.getFirst(); curr != null; curr = curr.succ)
        {
            if (curr.element.significance() > mostsig.element.significance())
            {
                mostsig = curr;
            }
        }

        firstSorcererCards.delete(mostsig);
        secondSorcererCards.insertAfter(mostsig.element, secondSorcererCards.getFirst().succ.succ.succ);
    }
